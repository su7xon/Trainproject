        ...
        {actions.map((action, index) => {
          ...
          return (
            <Link
              key={index}
              to={action.path}
              className={`group relative overflow-hidden rounded-2xl bg-gradient-to-br ${action.color} ${action.hoverColor} text-white transition-all duration-300 transform hover:scale-105 hover:shadow-2xl animate-fade-in-up`}
            ...
            >
              ...
              <div className="relative p-6 flex flex-col h-full min-h-[160px]">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="w-2 h-2 bg-white/60 rounded-full group-hover:bg-white group-hover:scale-150 transition-all duration-300"></div>
                </div>
