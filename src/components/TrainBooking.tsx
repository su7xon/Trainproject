      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100 animate-fade-in">
        ...
        <div className="flex justify-center -my-3 relative z-10">
          <button
            ...
            className={`p-2 bg-red-500 text-white rounded-full hover:bg-red-600 transition-all transform ${isSwapped ? 'rotate-180' : ''}`}
          >
        ...
        <button
          ...
          className="w-full bg-gradient-to-r from-red-500 to-red-600 text-white py-4 rounded-xl hover:from-red-600 hover:to-red-700 transition-all font-semibold text-lg disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl transform hover:-translate-y-1"
        >
          ...
          <div className="grid sm:grid-cols-2 gap-3">
            {popularRoutes.map((route, index) => (
              <button
                ...
                className="p-4 border border-gray-200 rounded-xl hover:border-red-300 hover:bg-red-50 transition-all text-left group animate-fade-in-up"
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 animate-fade-in">
          ...
          <div className="space-y-4">
            {searchResults.map((train, index) => (
              <div key={index} className="border border-gray-200 rounded-xl p-4 hover:shadow-lg transition-all animate-slide-in-up" style={{ animationDelay: `${index * 0.1}s` }}>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
                  {train.classes.map((cls: any, clsIndex: number) => (
                    <button
                      ...
                      className="p-3 border border-gray-200 rounded-lg hover:border-red-300 hover:bg-red-50 transition-all"
                    >
